...
the API shape of the Driver_KeysightLCR `lcr_meter.py` module so it drops into the
same worker / recorder architecture (see ../Experiment_SMACharacterizationV2/workers.py).
