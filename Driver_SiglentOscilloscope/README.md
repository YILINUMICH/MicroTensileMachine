...
the API of the [Driver_KeysightLCR](../Driver_KeysightLCR/README.md) `lcr_meter.py` module so it
...
in `../Experiment_SMACharacterizationV2/workers.py` maps onto it identically:
