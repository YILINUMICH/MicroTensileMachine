...
# Module logger name: "Driver_ZaberStage"
logger = logging.getLogger("Driver_ZaberStage")
```
...
`Driver_ZaberStage/`. The pattern is: the calling module carries a config file
...
Current configs that live in `Driver_ZaberStage/` for historical reasons:
