> **Status: Diagnostic** — **cp0–cp10 all bench-verified.** Phase 1 chip-level baseline COMPLETE 2026-05-24. Headline: 1.23 µV RMS noise floor at 400 SPS / PGA bypass; AIN2/3 saturation question retired (no pair fails); ADC2 verified working; DRDY interrupt-capable on PC_6; EVM AVDD measured ratiometrically at 5.2056 V. See [STATUS.md](STATUS.md) for the working pin defines and register settings. See [../README.md](../README.md) for project overview. See [`../doc/MEMO_baseline_testing.md`](../doc/MEMO_baseline_testing.md) for the wider Phase 1 testing plan (this module implements its Phase 1.1 + 1.3–1.6).
