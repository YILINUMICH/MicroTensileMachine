> **Status: To-Test** — bench-verified on Mid Carrier + bare TI EVM on 2026-05-25 (dual-stream clean, both channels track multimeter). Flips to Stable once `Experiment_SMACharacterizationV2/` consumes this stream end-to-end. See [STATUS.md](STATUS.md) for module-level state and TODOs. See [../README.md](../README.md) for project overview.

# Firmware_SensorHub_PIO — dual-ADC firmware (load cell + laser head)
